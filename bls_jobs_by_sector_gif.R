...
#Setting BLS API
Sys.getenv("29909ff415ed43ad93df779cf69778dc")
...
ggplot(df1, aes(x = date, y=value, fill=variable)) + 
  ...
  labs(caption = "Gif by Mike Farquharson using BLS data.") +
  ylab("Employees, in thousands (Seasonally Adjusted)") +
  ggtitle("Visualizing Payroll Employment by Industry 2020 - 2021") +
  transition_reveal(date)

anim_save(filename = "bls.gif")
